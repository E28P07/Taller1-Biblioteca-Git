...
public class Main {
    ...
    public static void crearLibro() {
        ...
        System.out.print("Dispoible: ");
        int disponible = sc.nextInt();
        sc.nextLine();

        Libro libro = new Libro(codigo, titulo, publicacion, autor, disponible);
        libros.add(libro);
    ...
    public static void actualizarLibro() {
        ...
        if (libro != null) {
            ...
            System.out.print("Nuevo Anio Publicacion: ");
            libro.setAnioPublicacion(sc.nextLine());
            System.out.print("Nueva Autor: ");
            libro.setAutor(sc.nextLine());
            System.out.print("Nuevo Disponible: ");
